  ...
  return (
    <>
      ...
      <main className="min-h-screen max-md:min-h-[calc(100vh-1rem)] flex flex-col items-center justify-between max-md:justify-end px-5 pt-6 pb-4 max-md:pb-3 relative z-10 text-center select-none">
        {/* Main Title & Action — Card Glass elevado +30px (mb-[50px]) exclusivamente no Mobile */}
        <div
          className="w-full max-w-md my-auto max-md:my-0 max-md:mt-auto max-md:mb-[50px] flex flex-col items-center justify-center gap-7 sm:gap-10 max-md:bg-black/35 max-md:backdrop-blur-md max-md:p-6 max-md:rounded-3xl max-md:border max-md:border-white/15 max-md:shadow-2xl"
          style={{
