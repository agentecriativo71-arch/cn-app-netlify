...
As chaves privadas devem ser configuradas somente como variáveis de runtime do servidor (`FAL_KEY`, `OPENAI_API_KEY`, `SUPABASE_SERVICE_KEY` e `CRM_SUPABASE_SERVICE_KEY`), nunca com prefixo `VITE_` e nunca como argumentos de build.
